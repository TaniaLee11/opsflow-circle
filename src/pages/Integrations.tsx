...
export default function Integrations() {
  ...
  const handleCreate = () => {
    ...
    showToast("Integrations created");
  ...
  return (
    <div style={ { display: "flex", height: "100vh", background: C.bg, fontFamily: "'DM Sans', sans-serif" } }>
      ...
      <main style={ { marginLeft: 220, flex: 1, overflowY: "auto", padding: 32 } }>
        <PageHeader
          breadcrumb="Systems → Integrations"
          title="Integrations"
          desc="Connect external tools and services"
          actionLabel="Create"
          actionColor={departmentColors.systems}
        ...
        <CreateModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Create Integrations" onSave={handleCreate} saveColor={departmentColors.systems}>
