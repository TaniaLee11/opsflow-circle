      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-foreground">Virtual OPS Hub</span>
          </div>
          <div className="flex items-center gap-4">
            <Button variant="ghost" onClick={() => navigate("/auth")}>
              Sign In
            </Button>
            <Button onClick={() => navigate("/auth?mode=signup")} className="glow-primary-sm">
              Get Started
            </Button>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8">
              ...
              <span className="text-sm text-primary font-medium">AI-Powered Operations</span>
            </div>

            <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6 leading-tight">
              Your Operating System for
              <span className="text-gradient block mt-2">Business & Mission</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button size="lg" variant="outline" onClick={() => document.getElementById('how-it-works')?.scrollIntoView({ behavior: 'smooth' })} className="text-lg px-8 h-14">
                See How It Works
              </Button>
            </div>
          </motion.div>
          ...
          >
            <div className="glass gradient-border rounded-2xl p-4 max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {audienceIdentities.map((identity, index) => (
              <motion.div
                ...
                className="glass gradient-border rounded-xl p-6 flex items-start gap-4"
              >
                <div className="p-2 rounded-lg bg-primary/10 shrink-0">
                  <CheckCircle2 className="w-5 h-5 text-primary" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">{identity.title}</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {operatingPaths.map((path, index) => (
              <motion.button
                ...
                className="glass rounded-xl p-6 text-left group hover:glow-primary-sm transition-all border border-border hover:border-primary/50"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-sm text-muted-foreground">Growth Path</span>
              </div>
              <div className="space-y-4">
      ...
      <footer className="border-t border-border py-12 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-muted-foreground">© 2024 Virtual OPS Hub</span>
          </div>
