...
const advisedAndSupported: Partner[] = [
  {
    name: "Ren360",
        ...
        <section className="py-12 sm:py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <div className="grid gap-8 md:grid-cols-2">
                {advisedAndSupported.map((partner, index) => (
                  <PartnerCard key={partner.name} partner={partner} index={index + 2} tagline="Advised and supported by Virtual Ops." />
                ))}
              </div>
            </motion.div>
          </div>
