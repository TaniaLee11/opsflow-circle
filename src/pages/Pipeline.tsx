    ...
    <div style={ { display: "flex", height: "100vh", background: C.bg, fontFamily: "'DM Sans', sans-serif" } }>
      ...
      <main style={ { marginLeft: 220, flex: 1, overflowY: "auto", padding: 32 } }>
        <PageHeader
          ...
          title="Pipeline"
          desc="Manage sales pipeline and deals"
          actionLabel="Create"
        ...
        <CreateModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Create Pipeline" onSave={handleCreate} saveColor={departmentColors.sales}>
