...
export default function CashFlow() {
  ...
  const handleCreate = (data: any) => {
    ...
    showToast('success', 'Cash Flow Entry created successfully');
  };
    ...
    <div style={{ marginLeft: 220, minHeight: '100vh', background: C.bg }}>
      ...
      <main style={{ padding: 32 }}>
        <PageHeader 
          ...
          icon={TrendingUp}
          action={{
            label: "Add Cash Flow Entry",
            onClick: () => setShowCreateModal(true),
            color: "#059669"
          }}
        />
        
        <VOPSyInsight page="cashflow" userContext={userContext} />
