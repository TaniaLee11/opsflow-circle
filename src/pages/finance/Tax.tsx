...
export default function Tax() {
  ...
  const handleCreate = () => {
    ...
    showToast("Tax Organizer created");
  ...
  return (
    <div style={{ display: "flex", height: "100vh", background: C.bg, fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <main style={{ marginLeft: 220, flex: 1, overflowY: "auto", padding: 32 }}>
        <PageHeader
          breadcrumb="Finance → Tax Organizer"
          title="Tax Organizer"
          desc="Organize tax documents and track deadlines"
          actionLabel="Create"
        ...
        <CreateModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Create Tax Organizer" onSave={handleCreate} saveColor={departmentColors.finance}>
