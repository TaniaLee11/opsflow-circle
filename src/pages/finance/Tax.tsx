...
export default function TaxOrganizer() {
  ...
  const handleCreate = (data: any) => {
    ...
    showToast('success', 'Tax Document created successfully');
  };
  ...
  const handleDelete = () => {
    ...
    showToast('success', 'Tax Document deleted');
  };
  ...
  return (
    <div style={{ marginLeft: 220, minHeight: '100vh', background: C.bg }}>
      ...
      <main style={{ padding: 32 }}>
        ...
        <VOPSyInsight page="tax" userContext={userContext} />
