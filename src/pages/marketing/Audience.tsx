...
export default function AudienceInsights() {
  ...
  const handleCreate = (data: any) => {
    ...
    showToast('success', 'Audience Segment created successfully');
  };
  ...
  const handleDelete = () => {
    ...
    showToast('success', 'Audience Segment deleted');
  };
  ...
  return (
    <div style={{ marginLeft: 220, minHeight: '100vh', background: C.bg }}>
      ...
      <main style={{ padding: 32 }}>
        ...
        <VOPSyInsight page="audience" userContext={userContext} />
          ...
          <div style={{
            ...
            <div style={{ color: C.text2, fontSize: 13, marginBottom: 20, lineHeight: 1.5 }}>
              {isConnected 
                ...
                : 'Add audience segments manually or connect GoHighLevel to sync automatically.'
              }
            </div>
