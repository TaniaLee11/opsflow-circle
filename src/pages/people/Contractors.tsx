  ...
  return (
    <div style={ { display: "flex", height: "100vh", background: C.bg, fontFamily: "'DM Sans', sans-serif" } }>
      ...
      <main style={ { marginLeft: 220, flex: 1, overflowY: "auto", padding: 32 } }>
        <PageHeader
          breadcrumb="People → Contractors"
          title="Contractors"
          desc="Manage contractors and freelancers"
          actionLabel="Create"
        ...
        <CreateModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Create Contractors" onSave={handleCreate} saveColor={departmentColors.people}>
