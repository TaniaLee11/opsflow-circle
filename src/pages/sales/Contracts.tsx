  ...
  return (
    <div style={ { display: "flex", height: "100vh", background: C.bg, fontFamily: "'DM Sans', sans-serif" } }>
      ...
      <main style={ { marginLeft: 220, flex: 1, overflowY: "auto", padding: 32 } }>
        <PageHeader
          breadcrumb="Sales → Contracts"
          title="Contracts"
          desc="Manage contracts and agreements"
          actionLabel="Create"
          actionColor={departmentColors.sales}
        ...
        <CreateModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Create Contracts" onSave={handleCreate} saveColor={departmentColors.sales}>
