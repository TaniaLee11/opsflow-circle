...
export default function Calendar() {
  ...
  const isConnected = userContext.integrations.includes('google calendar');
  ...
  return (
    <div style={{ marginLeft: 220, minHeight: '100vh', background: C.bg }}>
      ...
      <main className="p-6 lg:p-8">
        <PageHeader 
          title="Calendar"
          subtitle="{isConnected ? 'Connected to Google Calendar' : 'Track manually or connect Google Calendar'}"
          icon={Calendar}
          action={{
            label: "Add Event",
        ...
        <VOPSyInsight page="calendar" userContext={userContext} />
        ...
        {items.length === 0 ? (
          <div style={{
            ...
            <div style={{ color: C.text2, fontSize: 13, marginBottom: 20, lineHeight: 1.5 }}>
              {isConnected 
                ? 'Data will appear after your first sync with Google Calendar.'
                : 'Add events manually or connect Google Calendar to sync automatically.'
              }
            </div>
