...
export default function Tasks() {
  ...
  const isConnected = userContext.integrations.includes('asana');
  ...
  return (
    <div style={{ marginLeft: 220, minHeight: '100vh', background: C.bg }}>
      ...
      <main className="p-6 lg:p-8">
        ...
        <VOPSyInsight page="tasks" userContext={userContext} />
        ...
        {items.length === 0 ? (
          <div style={{
            ...
            <div style={{ color: C.text2, fontSize: 13, marginBottom: 20, lineHeight: 1.5 }}>
              {isConnected 
                ? 'Data will appear after your first sync with Asana.'
                : 'Add tasks manually or connect Asana to sync automatically.'
              }
            </div>
